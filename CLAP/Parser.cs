...
namespace CLAP
{
    ...
    public partial class Parser : MultiParser
    {
        ...
        public static object Run(string[] args, params object[] targets)
        {
        ...
        /// <param name="args">The user arguments</param>
        public static object Run<T>(string[] args)
        ...
        public static object Run<T>(string[] args, T t)
        ...
        /// </summary>
        /// <param name="args">The user arguments</param>
        public static object Run<T1, T2>(string[] args)
        ...
        public static object Run<T1, T2>(string[] args, T1 t1, T2 t2)
        ...
        /// </summary>
        /// <param name="args">The user arguments</param>
        public static object Run<T1, T2, T3>(string[] args)
        ...
        public static object Run<T1, T2, T3>(string[] args, T1 t1, T2 t2, T3 t3)
        ...
        /// </summary>
        /// <param name="args">The user arguments</param>
        public static object Run<T1, T2, T3, T4>(string[] args)
        ...
        public static object Run<T1, T2, T3, T4>(string[] args, T1 t1, T2 t2, T3 t3, T4 t4)
        ...
        /// </summary>
        /// <param name="args">The user arguments</param>
        public static object Run<T1, T2, T3, T4, T5>(string[] args)
        ...
        public static object Run<T1, T2, T3, T4, T5>(string[] args, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5)
        ...
        /// </summary>
        /// <param name="args">The user arguments</param>
        public static object Run<T1, T2, T3, T4, T5, T6>(string[] args)
        ...
        public static object Run<T1, T2, T3, T4, T5, T6>(string[] args, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6)
        ...
        /// </summary>
        /// <param name="args">The user arguments</param>
        public static object Run<T1, T2, T3, T4, T5, T6, T7>(string[] args)
        ...
        public static object Run<T1, T2, T3, T4, T5, T6, T7>(string[] args, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7)
        ...
        /// </summary>
        /// <param name="args">The user arguments</param>
        public static object Run<T1, T2, T3, T4, T5, T6, T7, T8>(string[] args)
        ...
        public static object Run<T1, T2, T3, T4, T5, T6, T7, T8>(string[] args, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8)
        ...
        /// </summary>
        /// <param name="args">The user arguments</param>
        public static object Run<T1, T2, T3, T4, T5, T6, T7, T8, T9>(string[] args)
        ...
        public static object Run<T1, T2, T3, T4, T5, T6, T7, T8, T9>(string[] args, T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7, T8 t8, T9 t9)
